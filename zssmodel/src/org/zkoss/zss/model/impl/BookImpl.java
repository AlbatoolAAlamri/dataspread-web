...
public class BookImpl extends AbstractBookAdv{
	...
	public void checkDBSchema() {
			 ...
			 Statement stmt = connection.createStatement())
		{
			...
			String createDirtyTable = "CREATE  UNLOGGED  TABLE " + bookTable + "_dirtytable (\n" +
					"  sheetid       INTEGER              NOT NULL,\n" +
					"  row           INTEGER              NOT NULL,\n" +
					"  col           INTEGER              NOT NULL,\n" +
					"  lastrow       INTEGER              NOT NULL,\n" +
					"  lastcol       INTEGER              NOT NULL,\n" +
					"  PRIMARY KEY (sheetid, row, col, lastrow, lastcol))";
			stmt.execute(createDirtyTable);
			...
			for (SSheet sheet:getSheets())
			{
				...
				insertSheetStmt.setString(6, sheet.getDirtyTable().getName());
...
//	@Override
//	public UpdateTable createUpdateTable(String name, UpdateTable src){
//
//	}
